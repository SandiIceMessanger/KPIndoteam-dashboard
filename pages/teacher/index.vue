        ...
        <table id="datatablesSimple" border="1">
            ...
            <tbody>
                <tr v-for="data in fetchedKanalCategoryImq.data" v-bind:key="data.id">
                    ...
                    <td>{{data.TeacherPhoneNumber}}</td>
                    <td>{{data.TeacherPoint}}</td>
                </tr>
            </tbody>
        </table>
    </div>
                  ...
                  <div class="media-body">
                    ...
                    <div class="box-user">
                      ...
                      <div class="box-post-date">
                        <span
                          ><i class="fas fa-circle"></i> {{data.TeacherPhoneNumber}}</span
                        >
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  async fetch({ params, store, error, req }) {
    let urlKanalWidgetImq = `https://nameless-fjord-04255.herokuapp.com/api/v1/teachers`;
