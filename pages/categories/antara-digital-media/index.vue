        ...
        <div class="row">
          <div class="col-12 col-sm-8 col-md-8 col-lg-8">
            <div class="master-chanel">
              <!---->
              <div class="vue-horizontal-list" style="border-radius: calc(.25rem - 1px) calc(.25rem - 1px) 0 0; border-radius: 8px;">
                      ...
                      <div class="item">
                        <div class="layer-image" style="border: 1px solid rgba(0,0,0,.125); border-radius: 8px;">
                          <div
                            ...
                            :style="{ background: `url(${fetchedKanalCategoryImq.trending[0].image.medium == null ? noImage : fetchedKanalCategoryImq.trending[0].image.medium})`}"
                          >
                            <div class="box-main-artikel">
                              <div class="caption">
                                <a
                                 
                                  :href="fetchedKanalCategoryImq.trending[0].url" target="_blank"
                                  ><h2>
                                   {{this.fetchedKanalCategoryImq.trending[0].post_title}}
                                  </h2></a
                                >
                                <div class="caption-info">
                                  <div class="caption-date">
                                    ...
                                    ></i>
                                    <span>{{formatDateList(this.fetchedKanalCategoryImq.trending[0].post_date)}}</span>
                                  </div>
                                  <div
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="list-kanal">
                    <div
                      class="media"
                      v-for="data in fetchedKanalCategoryImq.trending.slice(0, 3)"
                      v-bind:key="data.id"
                    >
                      <div class="media-body">
                        <div class="desc-artikel">
                          <a :href="data.url" target="_blank">
                            <h3 class="mt-0 mb-2">{{ data.post_title }}</h3>
                          </a>
                        </div>
                        <div class="box-user">
                          <div class="box-post-date">
                            <client-only>
                              <span>{{ formatDateList(data.post_date) }}</span>
                            </client-only>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div class="img-thumb">
                          <a :href="data.url" target="_blank">
                            <div style="border: 1px solid rgba(0,0,0,.125); border-radius: 8px;">
                              <div class="bg-img-thumb" :style="{background: `url(${data.image.thumbnail == null ? noImage : data.image.thumbnail})`}" />
                            </div>
                          </a>
                        </div>
                      </div>
          ...
          <div>
            <div class="list-article">
              <ul class="list-unstyled">
                ...
                <li class="media py-3" v-for="data in fetchedKanalCategoryImq.home.slice(0, 3)" v-bind:key="data.id">
                  <div class="media-body">
                    <a :href="data.url" target="_blank">
                      <h5 class="mt-0">
                        {{data.post_title}}
                    ...
                    <div class="box-user">
                      ...
                      <div class="box-post-date">
                        <span
                          ><i class="fas fa-circle"></i> {{formatDateList(data.post_date)}}</span
                        >
                      </div>
                    </div>
                  </div>
                  <div class="img-thumb-cat">
                    <a :href="data.url" target="_blank"><div class="box-label">
                        <span class="label-categories"
                          >Antara Digital Media</span
                        >
                      </div>
                      <div class="box-image-post">
                        <div class="box-no-image">
                            <img :src="data.image.thumbnail" class="bg-img-thumb" :alt="data.post_title" noImage>
                            <div class="bg-img-thumb" :style="{background: `url(${data.image.thumbnail == null ? noImage : data.image.thumbnail})`}" />
