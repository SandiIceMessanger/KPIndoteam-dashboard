      ...
      <div class="row">
        <div class="col-12 col-sm-8 col-md-8 col-lg-8 mx-auto">
          <div class="media-siber">
            ...
            <div class="box-updated mt-4">
              <p>Jakarta, 3 Februari 2012</p>
              <p class="att">(Pedoman ini ditandatangani oleh Dewan Pers dan komunitas pers di Jakarta, 3 Februari 2012).</p>
            </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    head() {
      return {
        titleTemplate: 'Pedoman Media Siber - %s',
      }
    },
    computed: {
