<template>
  <div>
    <div class="row" v-if="fetchedKanalCategoryImq.length != 0">
      <div class="col-12 col-sm-8 col-md-8 col-lg-8">
        <div class="master-chanel">
          <SkeletonCarousel v-if="showLoadingCarousel"></SkeletonCarousel>
          <vue-horizontal-list :items="fetchedKanalCategoryImq.headline" :options="options" v-if="showCarousel">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="list-kanal">
                <div class="media" v-for="item in fetchedKanalCategoryImq.trending" v-bind:key="item.id">
...
<script>
  ...
  export default {
    ...
    async mounted() {
      ...
      console.log(this.$store.state.artikel)
    },
    methods: {
